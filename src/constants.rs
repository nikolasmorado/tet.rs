...
// pub const RED_TILE: &str = "██";
// pub const GREEN_TILE: &str = "██";
// pub const YELLOW_TILE: &str = "██";
// pub const BLUE_TILE: &str = "██";
// pub const CYAN_TILE: &str = "██";
// pub const ORANGE_TILE: &str = "██";
// pub const MAGENTA_TILE: &str = "██";
//
// pub const RED_GHOST: &str = "░░";
// pub const GREEN_GHOST: &str = "░░";
// pub const YELLOW_GHOST: &str = "░░";
// pub const BLUE_GHOST: &str = "░░";
// pub const CYAN_GHOST: &str = "░░";
// pub const ORANGE_GHOST: &str = "░░";
// pub const MAGENTA_GHOST: &str = "░░";
...
pub const ORANGE_TILE: &str = "\x1b[38;5;214m██\x1b[0m";
